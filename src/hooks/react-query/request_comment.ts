...
export const useAddRequestComment = (requestId: string | undefined) => {
...
export const useDeleteRequestComment = (requestId: string | undefined) => {
  const queryClient = useQueryClient();
...
export const useUpdateRequestComment = (requestId: string | undefined) => {
  const queryClient = useQueryClient();
