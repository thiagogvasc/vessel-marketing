...
export const TaskProperty: React.FC<TaskPropertiyProps> = ({
  ...
  const [newPropertyValue, setNewPropertyValue] = useState<any>(propertyWithDefinition.value);
  ...
  return (
    <>
            ...
            {isEditingValue ? (
              definition.type === "Text" ? (
                ...
                <FormControl fullWidth>
                  <InputLabel id={`${definition.id}-edit-label`}>Select</InputLabel>
                  <Select
        ...
        <Menu anchorEl={editMenuAnchorEl} open={Boolean(editMenuAnchorEl) && !isEditingProperty} onClose={handleMenuClose}>
